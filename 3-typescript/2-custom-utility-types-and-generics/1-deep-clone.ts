...
import { Carlos, Product } from "../1-ecommerce/1-types";
...
const twoProducts: Product[] = [
  {
    ...
    isVisible: true,
    description:
      "Designed for serious trail runners, the Horizon Trail Rush features aggressive lugs for maximum traction on varied terrain. The breathable upper keeps feet cool while protective overlays shield against rocks and debris.",
    ...
    taxCode: "TRAIL888",
    metaTagDescription:
      "Conquer any trail with superior grip and all-day comfort.",
    supplierId: 5,
  ...
  },
  {
    ...
    isVisible: true,
    description:
      "Dominate the tennis court with the Velocity Pro Court Victory. Engineered for quick lateral movements and stability during intense matches, with a durable outsole specifically designed for court surfaces.",
    ...
    taxCode: "COURT222",
    metaTagDescription:
      "Professional-grade tennis shoes with superior lateral support.",
    supplierId: 7,
...
const result = deepClone<Product[]>(twoProducts);
console.log(result);
