...
function getDepartmentsWithProductCount(departments, products) {
    return __awaiter(this, void 0, void 0, function () {
        var departmentProducts;
        return __generator(this, function (_a) {
            departmentProducts = departments.map(function (department) {
                var productsInDepartment = products.filter(function (product) { return department.id === product.departmentId; });
                var departmentProduct = {
            ...
            return [2 /*return*/, departmentProducts];
        });
    });
}
Promise.all([
    ...
    var result = getDepartmentsWithProductCount(brands, products);
    return result;
})
